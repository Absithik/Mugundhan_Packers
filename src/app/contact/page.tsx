    ...
    return (
        <div className="bg-white">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
                        ...
                        <div className="flex flex-col justify-center gap-12">
                            <div className="space-y-4">
                                <h2 className="text-accent font-black uppercase tracking-[0.3em] text-sm">Main Branch</h2>
                                <h3 className="text-5xl font-black text-primary">Mumbai Head Office.</h3>
                                <div className="flex gap-4 pt-4">
                                    <MapPin className="text-accent shrink-0" size={32} />
                                    <p className="text-xl text-gray-text font-medium">
                                        Logistics Plaza, Sector 12, <br />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <a href="mailto:info@mugunthanpackers.com" className="p-8 rounded-[40px] border-2 border-primary/5 hover:border-accent transition-all group">
                                    ...
                                    <p className="text-gray-text font-bold">info@mugunthan.com</p>
                                </a>
                            </div>
            ...
            <section className="h-[500px] w-full bg-soft grayscale-100 contrast-125 overflow-hidden">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d120612.9818451121!2d72.8258!3d19.076!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d64cb77!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1620000000000!5m2!1sen!2sin"
                    width="100%"
                    height="100%"
                    style={{ border: 0 }}
