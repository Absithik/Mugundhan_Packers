...
const services = [
    {
        title: 'Shifting',
        description: 'Safe and seamless home and office relocation services across the city and beyond.',
        icon: (
    ...
    {
        title: 'Packing',
        description: 'Multi-layered protective packing using premium materials to safeguard your valuables.',
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
        ...
        description: 'Expert handling by trained professionals to ensure damage-free loading and unloading.',
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
        title: 'Transport',
        description: 'Reliable and timely transportation using specialized closed-container carriers.',
        icon: (
            <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
